...
{ 0, 9,wf, 'e',6, 15,K_ESC},/*140 ptrscr*/  //Esc 13x
{-13,0,wf, '1',2,139,K_F1},{X, 0,wf, '2',2,103,K_F2}, {X,0,wf, '3',2, 13,K_F3}, {X,0,wf, '4',2,110,K_F4},
...
{X,0,wh, '-',3,126,K_MINUS},{X, 0,wh, '=',3,132,K_EQUAL},{X,0,13,kH, '<',7, 91,K_BACK}, //Back 14x
/*138 home*/
...
{ X, 0,wh, ']',3, 96,K_RBRACE},{X,0, 9,kH,'\\',3, 55,K_BSLASH}, // \| 14x
/*137 pgup*/
...
{ X, 0,wh,'\'',3,  0,K_QUOTE},{X, 0,14,kH, 217,7, 37,K_ENT}, //Ent 13x
/*119 pgdn*/
...
{ X, 0,19,kH, 's',5, 58,K_RSHIFT}, //R Sh 12x
/*12 up 120 end*/
//modif:  L Ctrl, L Gui, L Alt, space, R Alt, App,K_Ss, R Gui, R Ctrl
{ 0,56,12,kH, 'c',4,128,K_LCTRL},{-12,0,8,kH,  9 ,4,106,K_LGUI}, /*14 \*/
{-8, 0,12,kH, 'a',4,  3,K_LALT},{-12,0,45,kH,' ',6,  9,K_SPACE}, //Space
{-45,0,10,kH, 'a',5, 21,K_RALT}, /*23 menu 136 ins 135 del  30 ri 27 dn 28 le */
{-10,0, 8,kH,  9 ,6, 23,K_RGUI},{-8,0, 9,kH,254,5,136,K_MENU},{-9, 0,13,kH,'c',5,135,K_RCTRL}, //R Ct 8x
//numpad: 17x
{XN,20,wh, 250,6, 45,K_NUML},{X, 0,wh, '/',3, 46,KP_DIV},{X,0,wh, 'x',3, 47,KP_MUL},{X,0,wh,  '-',3, 29,KP_SUB},
{XN,29,wh, '7',8, 81,K_HOME},{X, 0,wh, 24 ,8, 82,K_UP},  {X,0,wh, '9',8, 83,K_PGUP},{X,0,kW,kH*2,'+',3, 84,KP_ADD},
{XN,38,wh, 27 ,8, 99,K_LEFT},{X, 0,wh,  7 ,6,100,K_DEL}, {X,0,wh, 26 ,8,101,K_RIGHT},
{XN,47,wh, '1',8, 63,K_END}, {X, 0,wh, 25 ,8, 64,K_DOWN},{X,0,wh, '3',8, 65,K_PGDN},{X,0,kW,kH*2, 217,6, 66,KP_ENT}, //Ent
