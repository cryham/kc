...
void Ada4_ST7735::drawFastHLineInternal(int16_t x, int16_t y, int16_t w, uint16_t color)
{
...
void Ada4_ST7735::drawFastVLineInternal(int16_t x, int16_t __y, int16_t __h, uint16_t color) {
